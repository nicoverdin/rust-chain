...
([![CI Status](https://github.com/nicoverdin/rust_chain/actions/workflows/rust_ci.yml/badge.svg)](https://github.com/nicoverdin/rust_chain/actions/workflows/rust_ci.yml))
