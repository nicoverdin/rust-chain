...
![RustChain CI]([![CI Status](https://github.com/nicoverdin/rust_chain/actions/workflows/ci_rust.yml/badge.svg)](https://github.com/nicoverdin/rust_chain/actions/workflows/ci_rust.yml))
